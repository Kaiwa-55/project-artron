...
func run_test() -> void:
	...
	check(prototype.get_node("UILayer/Control/ReferenceActionDock") != null, "reference-style horizontal Action Dock should be available")
	...
	var action_grid: GridContainer = prototype.get_node("UILayer/Control/ReferenceActionDock/ActionDockMargin/ActionDockColumn/ActionButtonGrid")
	...
	check(prototype.get_node("UILayer/Control/ReferenceTurnHUD") != null, "reference-style AP and End Turn panel should be available")
	var action_dock: Control = prototype.get_node("UILayer/Control/ReferenceActionDock")
	var turn_hud: Control = prototype.get_node("UILayer/Control/ReferenceTurnHUD")
